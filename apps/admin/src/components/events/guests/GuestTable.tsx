...
import type { PageResponseOrderAdminTableElement } from '@lib/apis/order/orderType';
import type { PageResponseIssuedTicketAdminTableElement } from '@lib/apis/ticket/ticketType';
